...
// ../.wrangler/tmp/bundle-SHpxS3/checked-fetch.js
...
async function onRequestGet(context) {
  try {
    const { results } = await context.env.DB.prepare("SELECT * FROM transactions ORDER BY created_at DESC").all();
...
// ../.wrangler/tmp/pages-hJtKUb/functionsRoutes-0.21907996987406553.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-SHpxS3/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-SHpxS3/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3432414415415761.mjs.map
